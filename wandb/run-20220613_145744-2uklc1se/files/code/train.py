...
from transformers import BertModel, CLIPVisionModel, CLIPTextModel, CLIPTokenizer, CLIPProcessor
...
#loading dataset: 
    ...
    dataset = build(train_answers, train_questions, train_image_ids, 
