...
parser.add_argument('--simg', default=7, type=int, metavar='SI',
...
parser.add_argument('--nhead', default=5, type=int, metavar='NH',
...
#initializing the model: 
    ...
    model = SlotVQA(clip_vision_model, mbert, resolution=(224, 224), 
    ...
    for epoch in range(start_epoch, args.epochs): 
        ...
        if args.rank==0: 
            ...
            if step%args.print_freq==0: 
                ...
                wandb.log({"accuracy": acc*100/step2})
